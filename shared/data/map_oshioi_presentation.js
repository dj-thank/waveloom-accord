...
export const OSHIOI_PRESENTATION = deepFreeze({
  ...
  materials: {
    ...
    lanternGold: {
      type: 'standard', color: 0xffd48f, roughness: 0.3, metalness: 0.2,
      emissive: 0xd4913a, emissiveIntensity: 1.1,
    },
    shell: { type: 'standard', color: 0xf0e4cc, roughness: 0.88, metalness: 0.02 },
    basalt: { type: 'standard', color: 0x3e3a34, roughness: 0.73, metalness: 0.16 },
    ...
    wetRock: { type: 'standard', color: 0x2c4249, roughness: 0.58, metalness: 0.12 },
    ...
    indigoGlow: {
      type: 'standard', color: 0x4a86b8, roughness: 0.33, metalness: 0.28,
    ...
    windowGlow: {
      type: 'standard', color: 0xe8a94e, roughness: 0.33, metalness: 0.28,
